      ...
      <div className="positioning__inner">
        <div className="positioning__content">
          ...
          <p className="positioning__description">
            ...
            selling, we handle the details so you can focus on what matters.
            From listing to closing, we're here every step of the way.
          </p>
        </div>
        ...
        <div className="offerings">
          <div className="offering">
            ...
            <p className="offering__text">
              ...
              purchase with full transparency!
            </p>
          </div>
          ...
          <div className="offering">
            ...
            <p className="offering__text">
              ...
              your experience as simple as possible.
            </p>
          </div>
          ...
          <div className="offering">
            ...
            <p className="offering__text">
              ...
              Listing to Social Media Marketing.
            </p>
          </div>
